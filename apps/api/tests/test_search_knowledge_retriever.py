...
class FakeRetrieveKnowledge:
    def __init__(
        self,
        results: list[SearchResultDto] | None = None,
        *,
...
def test_successful_retrieval() -> None:
    ...
    retriever = SearchKnowledgeRetriever(retrieve_knowledge=fake)
...
def test_metadata_mapping() -> None:
    ...
    # knowledge_item_id remains Search-owned metadata and is not a RetrievedKnowledge field
