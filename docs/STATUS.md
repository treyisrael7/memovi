...
* Windows/macOS code signing and notarization; GitHub Releases / updater
...
* Windows/macOS code signing and notarization; GitHub Release automation
...
* Windows/macOS signing and notarization when cutting signed installers
