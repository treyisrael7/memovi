...
def test_score_normalizer_applies_min_max() -> None:
    results = [_result('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 10.0), _result('b2c3d4e5-f6a7-8901-bcde-f12345678901', 5.0), _result('c3d4e5f6-a7b8-9012-cdef-123456789012', 0.0)]
...
def test_score_normalizer_handles_equal_scores() -> None:
    results = [_result('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 0.3), _result('b2c3d4e5-f6a7-8901-bcde-f12345678901', 0.3)]
    normalized = ScoreNormalizer().normalize(results)
