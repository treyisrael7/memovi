...
def test_search_returns_matching_document(
    ...
    assert fake_search.last_query == RetrieveKnowledgeQuery(
        ...
        filters=SearchFilters(workspace_id=WorkspaceId.default()),
...
def test_search_passes_mime_type_filter(
    ...
    assert fake_search.last_query == RetrieveKnowledgeQuery(
        ...
        offset=0,
        mode=RetrievalMode.HYBRID,
        filters=SearchFilters(workspace_id=WorkspaceId.default(), mime_type="text/markdown"),
        workspace_id=WorkspaceId.default(),
    )
...
def test_search_passes_source_type_filter(
    ...
    assert fake_search.last_query == RetrieveKnowledgeQuery(
        ...
        offset=0,
        mode=RetrievalMode.HYBRID,
        filters=SearchFilters(workspace_id=WorkspaceId.default(), source_type="upload"),
        workspace_id=WorkspaceId.default(),
    )
...
def test_search_passes_document_id_filter(
    ...
    assert fake_search.last_query == RetrieveKnowledgeQuery(
        ...
        offset=0,
        mode=RetrievalMode.HYBRID,
        filters=SearchFilters(workspace_id=WorkspaceId.default(), document_id=DOCUMENT_ID),
        workspace_id=WorkspaceId.default(),
    )
